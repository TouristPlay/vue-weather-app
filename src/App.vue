<script setup>
    import { OPEN_WEATHER_MAP_API_KEY, OPEN_WEATHER_MAP_API_URL } from "@/constants";
    ...
    const city = ref('Saransk');
    const weatherInfo = ref(null);

    function getWeather() {
        fetch(`${OPEN_WEATHER_MAP_API_URL}?q=${city.value}&appid=${OPEN_WEATHER_MAP_API_KEY}&units=metric`)
